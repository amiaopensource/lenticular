...
// imageProcessing.h RENAME THIS TO unaryImageoperations.h and also make a binaryImageoperations.h or what ????
...
/*
int copy_glImage( glImage_t *fromGlImage, glImage_t *toGlImage ); // isn't this imageHandling ???
*/
#endif
